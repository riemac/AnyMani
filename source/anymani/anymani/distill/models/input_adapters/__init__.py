...
route adapter 与 backbone final-norm unified $Z$ 构成 retained geometry encoder。这里不再建立一套与
PPO backbone 平行的“representation encoder”，避免 field target 更换时无意更换网络主干。
"""
