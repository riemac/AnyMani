...
> 现有问题：只能迁移到Leaphand家族的不同embodiment，无法迁移到不同的leaphand family以外的手型
1. Liu 等 - 2025 - DexNDM Closing the Reality Gap for Dexterous In-Hand Rotation via Joint-Wise Neural Dynamics Model.pdf (正文1-9页，附录14-47页)
...
1. Li 等 - 2026 - TOPPO Rethinking PPO for Multi-Task Reinforcement Learning with Critic Balancing.pdf（正文1-9页，附录12-38页）
