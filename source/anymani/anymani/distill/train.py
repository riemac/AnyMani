r"""Self-contained training entry for AnyMani distill.

本入口是层次通才策略训练的主入口，不再把 GM teacher 训练逻辑散落到项目根部
...
python -m anymani.distill.train --task AnyMani-GM-Teacher-Debug-v0 --num_envs 16 --headless
```
"""
